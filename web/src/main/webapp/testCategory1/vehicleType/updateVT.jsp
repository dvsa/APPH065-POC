...
<%@ page import="com.DSA.common.valueobject.VehicleTypeVO"%>
...
<table width="100%" ><tr><td class="bea-portal-window-titlebar" align="left">Update Vehicle Type<!-- <i18n:getMessage messageName="HEADER_UPDATE_VEHICLE_TYPE" /> --></td></tr></table>
<netui:form action="updateVT">
    <table border="0">
        <tr>
            <td>
                <%
            ...
            <td>
                <table>
                    <tr valign="top">
                        ...
                        <td align="left">
                            <netui:label value="${actionForm.codeLabel}" />
                            <netui:hidden dataSource="actionForm.codeLabel" dataInput="${actionForm.codeLabel}" />
                            <netui:hidden dataSource="actionForm.updatedDate" dataInput="${actionForm.updatedDate}" />        
                        </td>
                    </tr>
                    <tr valign="top">
                        <td  align="left" valign="top" class="field-label">      
                    ...
                    <tr valign="top">
                        ...
                        <td align="left">
                            ...
                            <span class="message">
				            <span class="field-instruction">(Days)<!-- <i18n:getMessage messageName="LBL_EXAM_SKILL_THRESHOLD_UNITS"/> --></span>
				            </span>
                        </td>
                    </tr>
                    <tr valign="top">
                    ...
                    <tr valign="top">
                        ...
                        <td align="left">
                            <netui:radioButtonGroup dataSource="actionForm.defaultType"><%--  tagId="defaultType"> --%>
                                <netui:radioButtonOption value="1" tagId="DefaultTypeYes">Yes<!-- <i18n:getMessage messageName="LBL_YES"/> --></netui:radioButtonOption>
                                <netui:radioButtonOption value="0" tagId="DefaultTypeNo">No<!-- <i18n:getMessage messageName="LBL_NO"/> --></netui:radioButtonOption>
        ...
        <tr>
            <td colspan="2" align="center" valign="top">
                ...
                <%
                	...
                	if (updatePermissionFlag.equals("1")) {
                %>
                &nbsp;<netui:button value="Update" type="submit" action="updateVT" styleClass="LoginBtn"/>
                <%
                    }
                %>
    ...
    <netui-data:callMethod object="${pageFlow}" method="resetErrorMessage" failOnError="true" resultId="resetErrMsg">
