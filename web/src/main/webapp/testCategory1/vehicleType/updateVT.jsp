...
<table width="100%" ><tr><td class="bea-portal-window-titlebar" align="left"><i18n:getMessage messageName="HEADER_UPDATE_VEHICLE_TYPE" /></td></tr></table>
    ...
    <table border="0">
                    ...
                    <tr valign="top">
                        ...
                        <td align="left">
                            <netui:radioButtonGroup dataSource="actionForm.defaultType"><%--  tagId="defaultType"> --%>
                                <netui:radioButtonOption value="1" tagId="DefaultTypeYes"><i18n:getMessage messageName="LBL_YES"/></netui:radioButtonOption>
                                <netui:radioButtonOption value="0" tagId="DefaultTypeNo"><i18n:getMessage messageName="LBL_NO"/></netui:radioButtonOption>
        ...
        <tr>
            <td colspan="2" align="center" valign="top">
                ...
                %>
                &nbsp;<netui:button value='<%=strUpdateBtn%>' type="submit" action="updateVT" styleClass="LoginBtn"/>
                <%
                    }
                %>
