...
<UL id=leftnavlist>
    ...
    <UL id=leftnavlist>
        ...
        <li>
            <!--<a href="${pageContext.request.contextPath}/DSAWeb/testCentre/TestCentreController.jpf">-->
  ...
  <ul>
    ...
    <li>
        ...
        <A href="${pageContext.request.contextPath}/DSAWeb/DSA.portal?_nfpb=true&_pageLabel=AgreementPage&_nfls=false">Agreements</A>
    </li>
